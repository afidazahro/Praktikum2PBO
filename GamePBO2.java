...
class GamePBO2 {
    ...
    GamePBO2(String name, double lifepoint){
    this.name = name;
    this.lifepoint = lifepoint;
}

    void kick(GamePBO2 opponent){
    ...
    public class GamePBO2{

    public static void main(String[] args) {
            // membuat object player
            GamePBO2 player1 = new Player("Raiden",100);
            GamePBO2 player2 = new Player("Sub-Zero",100);
